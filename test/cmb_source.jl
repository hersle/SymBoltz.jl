...
S1 = SymBoltz.S_splined(sol1, ks, ts) # sol1(ks, ts, M.S)
S2 = SymBoltz.S_splined(sol2, ks, ts) # sol2(ks, ts, M.S)
...
S2 = SymBoltz.S_splined(sol2, ks, exp.(lnts)) # sol2(ks, exp.(lnts), M.S)
Θl2s = SymBoltz.Θl(S2, ls, ks, lnts)
