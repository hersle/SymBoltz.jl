...
if true
    ...
    plot!(p[3,3], log10.(pt_sol[model.bg.g.a]), pt_sol[model.pt.cdm.u]; label="u = uc", ylabel="u")
    plot!(p[3,3], log10.(pt_sol[model.bg.g.a]), pt_sol[model.pt.bar.u]; label="u = ub")
    plot!(p[3,3], log10.(pt_sol[model.bg.g.a]), pt_sol[model.pt.ph.u]; label="u = uγ")
    plot!(p[3,3], log10.(pt_sol[model.bg.g.a]), pt_sol[model.pt.neu.u]; label="u = uν")
    plot!(p[3,3], log10.(pt_sol[model.bg.g.a]), pt_sol[model.pt.mneu.u]; label="u = umν")
    display(p)
end