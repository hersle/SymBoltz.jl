...
if true
    ...
    plot!(p[1,2], log10.(bg_sol[M.bg_sim.g.a]), stack(bg_sol[[M.bg_sim.γ.ρ, #=M.bg_sim.neu.ρ, M.bg_sim.mneu.ρ,=# M.bg_sim.c.ρ, M.bg_sim.b.ρ, M.bg_sim.Λ.ρ]] ./ bg_sol[M.bg_sim.G.ρcrit])'; xlabel="lg(a)", ylabel="Ω", label=["Ω = Ωγ" #="Ω = Ων" "Ω = Ωmν"=# "Ω = Ωc" "Ω = Ωb" "Ω = ΩΛ"], legend=:left)
