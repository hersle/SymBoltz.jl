...
if true
    ...
    plot!(p[1,2], log10.(bg_sol[model.bg_sim.g.a]), stack(bg_sol[[model.bg_sim.ph.ρ, model.bg_sim.neu.ρ, model.bg_sim.mneu.ρ, model.bg_sim.cdm.ρ, model.bg_sim.bar.ρ, model.bg_sim.de.ρ]] ./ bg_sol[model.bg_sim.grav.ρcrit])'; xlabel="lg(a)", ylabel="Ω", label=["Ωγ" "Ων" "Ωmν" "Ωc" "Ωb" "ΩΛ"], legend=:left)
    display(p)
end
