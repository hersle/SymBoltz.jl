...
The comparison shows how approximations and the ODE solver affects integration of the Einstein-Boltzmann equations.
...
and \cite{leeRapidAccurateNumerical2025} speed up CLASS using integral equations for massive neutrinos in the fork CLASSIER\footnote{\url{https://github.com/nanoomlee/CLASSIER}}.
...
The purpose of the comparison made here is to show the viability of approximation-free perturbations, which was a major milestone.
