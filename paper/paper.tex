...
A recent example of the transition to differentiable tools is the impressive end-to-end modeling from linear perturbation theory to non-linear structure formation with a differentiable Boltzmann code coupled to a differentiable $N$-body code by DISCO-DJ \citep{hahnDISCODJDifferentiableEinsteinBoltzmann2024,listDISCODJIIDifferentiable2025}.
