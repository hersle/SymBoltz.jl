...
SymBoltz is built somewhat differently than traditional Boltzmann codes.
...
SymBoltz encourages interactive use and pursues a modular design that lets users integrate whatever they need from the package into their own applications.
The end goal is to prioritize the modeler, who should be able to just write down their equations while SymBoltz takes care of the rest.
...
\textbf{This paper is as of SymBoltz version 0.14.0. Please see the package documentation for definitive up-to-date information.}
...
The next sections go into detail on its implementation.
...
\end{itemize}
\Cref{sec:performance} compares performance of these methods.
