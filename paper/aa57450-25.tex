...
This makes directly differentiable Boltzmann solvers a key addition to the modern cosmological modeling toolbox.
...
We hope to speed it up with future work.
...
\begin{figure}
    ...
    \caption{%
        ...
        Times are from a Linux laptop with a Intel i7-12800H CPU.}
    \label{fig:workprec}
\end{figure}
