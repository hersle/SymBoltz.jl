...
function S_observed(pt::PerturbationsSystem, ηs::AbstractArray, ks::AbstractArray, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp)
    pt_sols = solve(pt, ks, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp; saveat = ηs)
    Ss = zeros(eltype([Ωγ0, Ων0, Ωc0, Ωb0, h, Yp]), (length(ks), length(ηs))) # TODO: change order to get DenseArray during integrations?
...
function S_splined(pt::PerturbationsSystem, ηs::AbstractArray, ks::AbstractArray, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp)
    th = pt.th
    th_sol = solve(th, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp; saveat = ηs)
...
function S(pt::PerturbationsSystem, ηs::AbstractArray, ksfine::AbstractArray, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp, kscoarse::AbstractArray; Spline = CubicSpline, kwargs...) 
    Sscoarse = S_observed(pt, ηs, kscoarse, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp)
...
#Ss = S(ηs, ks, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp)
...
function Θl(pt::PerturbationsSystem, ls::AbstractArray, ks::AbstractRange, lnηs::AbstractRange, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp, args...; kwargs...)
    ηs = exp.(lnηs)
    Ss = S(pt, ηs, ks, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp, args...; kwargs...)
...
function Cl(pt::PerturbationsSystem, ls::AbstractArray, ks::AbstractRange, lnηs::AbstractRange, Ωγ0, Ων0, Ωc0, Ωb0, h, As, Yp, ks_S::AbstractArray; kwargs...)
    Θls = Θl(pt, ls, ks, lnηs, Ωγ0, Ων0, Ωc0, Ωb0, h, Yp, ks_S; kwargs...)
    P0s = P0(ks, As)
    return Cl(ls, ks, Θls, P0s)
end

function Cl(pt::PerturbationsSystem, ls::AbstractArray, Ωγ0, Ων0, Ωc0, Ωb0, h, As, Yp; Δlnη = 0.03, Δkη0 = 2π/4, Δkη0_S = 50.0, observe = false)
    ...
    return Cl(pt, ls, ks_Cl, lnηs, Ωγ0, Ων0, Ωc0, Ωb0, h, As, Yp, ks_S; observe)
end

Dl(pt::PerturbationsSystem, ls::AbstractArray, args...; kwargs...) = Cl(pt, ls, args...; kwargs...) .* ls .* (ls .+ 1) ./ 2π

#Dls = Dl(ls, ks, ηs, Ωγ0, Ων0, Ωc0, Ωb0, h, As, Yp; Sspline_ks)
