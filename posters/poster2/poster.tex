...
\author{\Large Herman Sletmoen \hspace{3.2cm} $\vcenter{\hbox{\includesvg[height=2.5cm]{uio-logo.svg}}}$ \hspace{3.2cm} \faGithub \, \url{github.com/hersle/SymBoltz.jl} \hspace{3.2cm} \aiarXiv \, \texttt{2509.24740}}
\institute{}
...
\block[bodyverticalshift=-0.7cm]{\huge Installation and documentation}{
\noindent
